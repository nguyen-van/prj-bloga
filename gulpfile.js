...
//  },
 ...
 // },
  path: {
    ...
    sass: {
      src: './wp-content/themes/tomato/assets/scss/**/*.scss',
      dest: './wp-content/themes/tomato/',
    },
//    js: {
...
gulp.task('watch', function(){
  ...
  gulp.watch(['./wp-content/themes/tomato/**/*.js'],　{interval: 0}, browserSync.reload);
  gulp.watch(['./wp-content/themes/tomato/**/*.php'],　{interval: 0}, browserSync.reload);
